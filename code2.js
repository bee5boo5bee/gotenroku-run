...
isConditionTrue_0 = gdjs.playerAuthentication.isAuthenticated();
if (isConditionTrue_0) {
{gdjs.evtTools.leaderboards.saveConnectedPlayerScore(runtimeScene, "931a3d67-6af8-4c27-8139-63b39337af5d", gdjs.evtTools.variable.getVariableNumber(runtimeScene.getGame().getVariables().getFromIndex(0)));
}}
...
{gdjs.evtTools.leaderboards.savePlayerScore(runtimeScene, "931a3d67-6af8-4c27-8139-63b39337af5d", gdjs.evtTools.variable.getVariableNumber(runtimeScene.getGame().getVariables().getFromIndex(0)), (( gdjs.GameOverCode.GDPlayerNameInputObjects3.length === 0 ) ? "" :gdjs.GameOverCode.GDPlayerNameInputObjects3[0].getString()));
...
let isConditionTrue_0 = false;
{
{gdjs.evtTools.leaderboards.displayLeaderboard(runtimeScene, "931a3d67-6af8-4c27-8139-63b39337af5d", true);
...
if (isConditionTrue_0) {
isConditionTrue_0 = false;
isConditionTrue_0 = gdjs.evtTools.leaderboards.hasBeenSaved("931a3d67-6af8-4c27-8139-63b39337af5d");
}
if (isConditionTrue_0) {
{gdjs.playerAuthentication.removeAuthenticationBanner(runtimeScene);
}{gdjs.evtTools.runtimeScene.replaceScene(runtimeScene, "Game", false);
